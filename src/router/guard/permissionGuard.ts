...
export function createPermissionGuard(router: Router) {
  ...
  router.beforeEach(async (to, from, next) => {
    ...
    console.log('basie_home', PageEnum.BASE_HOME)
    if (
      from.path === ROOT_PATH &&
    ...
    console.log('白名单', whitePathList.includes(to.path as PageEnum))
    ...
    console.log('pageroute.name', PAGE_NOT_FOUND_ROUTE.name)
