...
import { isArray, isBoolean, isFunction, isMap, isString, isUnDef } from '/@/utils/is';
import { cloneDeep, isEqual } from 'lodash-es';
import { formatToDate } from '/@/utils/dateUtil';
import { ACTION_COLUMN_FLAG, DEFAULT_ALIGN, INDEX_COLUMN_FLAG, PAGE_SIZE,DEFAULT_RESIZABLE  } from '../const';
  ...
  const getViewColumns = computed(() => {
    ...
    return columns
      ...
      .map((column) => {
        ...
        column.resizable = isUnDef(column.resizable) ? DEFAULT_RESIZABLE : column.resizable
