<script lang="tsx">
  ...
  import { getAllParentRoute } from '/@/router/helper/menuHelper'
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getCommonProps = computed(() => {
        ...
        const allParentPath = getAllParentRoute(menusRef.value, route.path);
        if (allParentPath.length) {
          menus = [allParentPath[0]];
        }
